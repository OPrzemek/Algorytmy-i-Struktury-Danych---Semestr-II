...
public class MinSTreeUnfixed {
    ...
    // określenie minimum wagi krawędzi w kolejce
    ...
    public static void main(String[] args){
        MinSTree obiektST = new MinSTree(8);
        ...
        while(true){
            ...
            for(Krawedz e:obiektST.graf.sasiedzi[v]){
                int w = e.drugi(v);
                System.out.println("krawędź " + v + " -> " + w + " " + e.waga());
                if(obiektST.oznaczone[w]) {System.out.println(w + " już oznaczone"); continue;}
